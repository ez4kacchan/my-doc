...
---
## Table of contents
## 1. Về các phiên bản của nội tâm
## 1.1. Self 1
...
Để **cảm nhận** Self 1 tốt nhất thì hãy quan sát lúc tôi tham gia vào game **Good-o**. Vì số lượng **không gian** dành cho suy nghĩ về **kết quả** chiếm đại số nên có thể thấy xuất hiện những **judgement** của **Self 1**. 

Tuy nhiên để **let go** Self 1 không thể bảo nó im lặng như một đứa con nít được. Bí quyết ở đây chính là **tập trung**. Khi tập trung thì Self 1 sẽ trở nên **tĩnh** hơn
...
### 1.2. Self 2 
Mọi hoạt động của chúng ta đều được thực hiện bởi Self 2, như là nhận diện hình ảnh, gõ bàn phím, quan sát bầu trời hoàng hôn đẹp đẽ, nhớ lại những kỉ niệm đẹp, ...

Self 2 cũng có **những nhu cầu** của nó. Nhưng khác với Self 1, đây là những nhu cầu **tự nhiên** từ khi tôi được sinh ra. Các điều thiết yếu ấy là được tận hưởng, được học, được hiểu, công nhận cái hay cái đẹp, hành động, nghỉ ngơi, có sức khỏe, tồn tại, được là chính nó, thể hiện chính nó và đóng góp một cách đặc biệt. 

Để mà **tôn trọng** Self 2 hơn, hãy nhớ quan sát những lúc Self 2 **thể hiện mình** nhé! 

Vậy thì để **dành chọn** không gian cho Self 2, tôi hãy hướng tới **sự tập trung thư giãn**

## 2. Mục đích
## 2.1. Mục đích của các cuộc thi là gì
Lấy ví dụ: 
...
## 7. Vậy thì mình đối diện với những thứ từ outer game như thế nào
...
- Khi mà mình ráng kiếm ra **công thức** để cho Self 2 làm thì **fail**, mình chỉ cung cấp **ingredient** cho Self 2 được thôi
- Tức là mình ko ra lệnh cho Self 2, mà tưởng tượng hình ảnh của results và để Self 2 tự làm những bước.
...
#### 8.2.3. Step 3: Tin tưởng vào Self 2
Đây là giai đoạn mình sẽ thực hiên. Đừng dùng bất cứ **conscious effort** nào để serve. Cứ để cú đá tự thực hiện. 

Bất kể kết quả như nào, để Self 1 ngoài rìa. Nếu cú sút không có độ chính xác, **đừng ép** nó phải chính xác.

Sau một khoảng thời gian, cú sút **thiệt sự trông** không di chuyển đúng hướng thì **trở lại** Step 1. **Aware** và tự hỏi điều gì đang cản trở. Có thể nhờ người khác. **Nhưng đừng cho rằng mình biết vì mình được nói vậy**. Nếu mà vẫn không sure thì nhờ ai đó show mình cái motion chứ không phải kể về nó. 

#### 8.2.4. Step 4: Quan sát một cách không phán xét của sự thay đổi và kết quả
Khi mà mình cho một **yếu tố** thay đổi những yếu tố khác sẽ bị thay đổi theo. Ban đầu sẽ có những sự thiếu đồng bộ về timing, ...Nhưng khi mà mình tiếp tục để cú sút tự sút thì các **yếu tố khác** sẽ tự điều chỉnh
